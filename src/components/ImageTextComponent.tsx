...
const ImageTextComponent: React.FC = () => {
  return (
    <div className="image-text-component flex flex-col lg:flex-row items-center lg:items-start p-4 bg-white rounded-lg shadow-lg">
      <div className="image-container flex-shrink-0 w-full lg:w-1/2 mb-4 lg:mb-0 lg:mr-4">
        <img src={image} alt="Barbería" className="w-full h-auto rounded-lg shadow-md" />
      </div>
      <div className="text-container flex-grow p-4 lg:p-8">
